...
class InitialActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val citiesByCountry = mapOf(
            ...
            "臺中市" to listOf("中區", "東區", "南區", "西區", "北區", "西屯區", "南屯區", "北屯區", "大里區", "太平區", "大雅區", "東勢區", "石岡區", "新社區", "南區"),
            "臺南市" to listOf("中西區", "東區", "南區", "北區", "安平區", "安南區", "永康區", "歸仁區", "新化區", "新營區", "鹽水區", "白河區", "柳營區", "後壁區", "東山區", "麻豆區", "官田區", "大內區", "山上區"),
            ...
            "臺東縣" to listOf("台東市", "成功鎮", "關山鎮", "卑南鄉", "鹿野鄉", "池上鄉", "東河鄉", "長濱鄉", "太麻里鄉", "大武鄉", "綠島鄉", "蘭嶼鄉"),
